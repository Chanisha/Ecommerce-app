  ...
  return (
    <div className="flex flex-col md:flex-row gap-8">
      ...
      <div className="md:w-1/2 space-y-6">
        ...
        <div>
          ...
          <div className="flex gap-3">
            {product.variants.map((variant) => (
              <button
                key={variant.color}
                className={`w-10 h-10 rounded-full border-2 transition-all duration-200 focus:ring-2 focus:ring-offset-2 ${
        ...
        <button
          onClick={onAddToCart}
          className="w-full py-4 bg-blue-600 text-white text-xl font-bold rounded-lg shadow-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        >
          Add to Cart
        </button>
      </div>
